...
app.post("/api/login", (req, res) => {
  ...
  if (user) {
    ...
    res.json({ username: user.username, login: login });
    console.log(`${user.username} successfully logged in with login ${login}`);
  } else {
    console.log(`error logged in with login ${login}`);
  }
